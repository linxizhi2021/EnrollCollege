...
class BaseProjectService extends BaseService {
	...
	async initSetup() {
		let F = (c) => 'bx_' + c;
		const INSTALL_CL = 'setup_zs1';
		const COLLECTIONS = ['setup', 'admin', 'log', 'news', 'enroll', 'enroll_join', 'fav', 'user', 'album'];
		const CONST_PIC = '/images/cover.gif';

		const NEWS_CATE = '1=学校概况,2=招生指南,3=入学须知,4=就业升学';
		const ALBUM_CATE = '1=校园环境,2=教学场所,3=生活设施,4=文体娱乐';
		const ENROLL_CATE = '1=文史类,2=财经类,3=理工类,4=艺术类';
